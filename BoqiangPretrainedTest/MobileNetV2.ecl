/*
About this test:
  Test the usability of Pre-trained Model MobileNetV2.
...
class                   probability
African_elephant	      0.5382263660430908
tusker	                0.3810980618000031
Indian_elephant	        0.01178644970059395
*/
...
SET OF REAL hexToNparry(DATA byte_array):= EMBED(Python)
  ...
  I_array = tf.keras.applications.mobilenet_v2.preprocess_input(I_array)
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.mobilenet_v2.MobileNetV2(weights = "imagenet")'''];
