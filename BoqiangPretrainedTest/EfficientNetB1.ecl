/*
About this test:
  Test the usability of Pre-trained Model EfficientNetB1.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/efficientnet/EfficientNetB1
  Input shape = (240, 240, 3) 

Results:

class                   probability
tusker	                0.7229413986206055
African_elephant	      0.1992634981870651
Indian_elephant	        0.01436837948858738
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.efficientnet.EfficientNetB1(weights = "imagenet")'''];
