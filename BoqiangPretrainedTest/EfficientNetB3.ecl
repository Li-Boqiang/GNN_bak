/*
About this test:
  Test the usability of Pre-trained Model EfficientNetB3.
...
class                   probability
tusker	                0.7228800654411316
African_elephant	      0.1308717578649521
Indian_elephant	        0.007874269969761372
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.efficientnet.EfficientNetB3(weights = "imagenet")'''];
