/*
About this test:
  Test the usability of Pre-trained Model MobileNet.
...
class                   probability
tusker	                0.8720258474349976
African_elephant	      0.1155058667063713
Indian_elephant	        0.0119769386947155
*/
...
SET OF REAL hexToNparry(DATA byte_array):= EMBED(Python)
  ...
  I_array = tf.keras.applications.mobilenet.preprocess_input(I_array)
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.mobilenet.MobileNet(weights = "imagenet")'''];
