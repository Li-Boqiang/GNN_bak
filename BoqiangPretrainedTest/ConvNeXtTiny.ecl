/*
About this test:
  Test the usability of Pre-trained Model ConvNeXtTiny.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/convnext/ConvNeXtTiny
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.convnext.ConvNeXtTiny(weights = "imagenet")'''];
