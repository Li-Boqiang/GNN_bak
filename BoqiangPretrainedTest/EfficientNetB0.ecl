/*
About this test:
  Test the usability of Pre-trained Model EfficientNetB0.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/efficientnet/EfficientNetB0
  Input shape = (224, 224, 3) 

Results:

class                   probability
tusker	                0.5464179515838623
African_elephant	      0.2663526237010956
Indian_elephant	        0.01894392631947994
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.efficientnet.EfficientNetB0(weights = "imagenet")'''];
