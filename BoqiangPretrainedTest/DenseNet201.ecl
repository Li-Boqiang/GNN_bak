/*
About this test:
  Test the usability of Pre-trained Model DenseNet201.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/densenet/DenseNet201
  Input shape = (224, 224, 3) 

Results:

class                   probability
tusker	                0.6310622692108154
African_elephant	      0.3531164824962616
Indian_elephant	        0.01568971946835518
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.densenet.DenseNet201(weights = "imagenet")'''];
