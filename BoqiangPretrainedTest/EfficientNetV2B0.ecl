/*
About this test:
  Test the usability of Pre-trained Model EfficientNetV2B0.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/efficientnet_v2/EfficientNetV2B0
  Input shape = (224, 224, 3) 

Results:

class                   probability
tusker	                0.5048235654830933
African_elephant	      0.39032182097435
Indian_elephant	        0.01535213924944401
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.efficientnet_v2.EfficientNetV2B0(weights = "imagenet")'''];
