/*
About this test:
  Test the usability of Pre-trained Model ConvNeXtSmall.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/convnext/ConvNeXtSmall
...
class                   probability
tusker	                9.01021957397461
African_elephant	      8.342575073242188
Indian_elephant	        4.326695919036865
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.convnext.ConvNeXtSmall(weights = "imagenet")'''];
