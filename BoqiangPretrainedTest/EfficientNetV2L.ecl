/*
About this test:
  Test the usability of Pre-trained Model EfficientNetV2L.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/efficientnet_v2/EfficientNetV2L
  Input shape = (480, 480, 3) 

Results:

class                   probability
tusker	                0.4311237633228302
African_elephant	      0.4106661975383759
Indian_elephant	        0.00598505511879921
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.efficientnet_v2.EfficientNetV2L(weights = "imagenet")'''];
