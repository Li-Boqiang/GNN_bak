/*
About this test:
  Test the usability of Pre-trained Model EfficientNetB2.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/efficientnet/EfficientNetB2
  Input shape = (260, 260, 3) 

Results:

class                   probability
tusker	                0.5454619526863098
African_elephant	      0.3253975808620453
Indian_elephant	        0.01168608292937279
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.efficientnet.EfficientNetB2(weights = "imagenet")'''];
